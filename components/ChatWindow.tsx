...
export function ChatWindow(props: {
  ...
  const choosePDFComponent = (
    <>
      <div className="hero min-h-screen rounded-lg flex flex-col justify-center">
            ...
            <div className="py-6">
              ...
              <ul className="text-left space-y-4">
                ...
                <li className="flex">
                  ...
                  <p className="ml-4">
                    {
                      "Using AWS Bedrock to interact with Llama 2 to handle conversations."
                    }
                  </p>
                </li>
                <li className="flex">
        ...
        <form
          onSubmit={embedPDF}
          className="mt-4 flex justify-center items-center w-full space-x-6"
        >
          <input
            id="file_input"
            type="file"
  ...
  const chatInterfaceComponent = (
    <>
      <div className="flex flex-col-reverse w-full mb-4 overflow-auto grow justify-center items-center">
        {messages.length > 0
          ? [...messages]
              .reverse()
              .map((m, i) => (
  ...
  return (
    <div
      className={`flex flex-col w-full justify-center items-center p-4 md:p-8 rounded grow overflow-hidden ${
        readyToChat ? "border" : ""
      }`}
    >
